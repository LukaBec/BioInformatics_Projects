...
def middle_edge(v,w):
    ...
    from_node = (mid_node_j,middle)
    edge = backtrack[mid_node_j]
    score = linear_sink[-1]
...
def LSA(v,w):
  ...
  """
    ...
    #output middle edge
    alignedV, alignedW, _ = LSA(v[top:midNodeI], w[left:middle])
    # midNodeI -= 1
    # midNodeJ -= 1
    ...
    if midEdge == 1 or midEdge == 0:
        midNodeI -= 1
    #secV, secW, _ = LSA(v[top:midNodeI], w[left:middle])
    # alignedV = secV + alignedV
    # alignedW = secW + alignedW
